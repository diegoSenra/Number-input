This is a very simple Restful SPA webapp, that consists of two pages: one that receives a numeric input and store it in db, and other that receives a number list (corresponding to id's in the numbers table) and presents the sum of the numbers stored in respective id's.

This was developed for practicing/demo purposes, using the following technologies: HTML, CSS, Javascript, React, Axios, C#, Asp.NET Core, MySql.
